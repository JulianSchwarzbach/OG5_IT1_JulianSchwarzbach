...
public class TankSimulator extends Frame {
	...
	public  Label lblProzents = new Label("                                ");
	...
	private Panel pnlSouth = new Panel(new GridLayout(2, 0));
